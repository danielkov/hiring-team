...
const Cta10 = ({
  ...
  description = "Join forward-thinking teams who are hiring faster and smarter with AI. Connect your Linear workspace and start screening candidates in minutes.",
  buttons = {
    primary: {
